...
public class GetArtifactoryServerExecutor implements Executor {
    ...
    private org.jfrog.hudson.pipeline.types.ArtifactoryServer artifactoryServer;
    ...
    public org.jfrog.hudson.pipeline.types.ArtifactoryServer getArtifactoryServer() {
    ...
    public void execute() {
        ...
        if (artifactoryServers.isEmpty()) {
            stepContext.onFailure(new NotFoundException("Couldn't find Artifactory named: " + artifactoryServerID));
        }
        ...
        artifactoryServer = new org.jfrog.hudson.pipeline.types.ArtifactoryServer(artifactoryServerID, server.getUrl(),
