...
public class GoDeployer extends Deployer {
    private String repo;
    ...
    public void deployArtifacts(BuildInfo buildInfo) {
        throw new IllegalStateException("The 'deployArtifacts' method is not supported for go builds. Please use the 'publish' method instead.");
    }
