...
public class NugetRunExecutor extends BuildInfoProcessRunner {
    ...
    public void execute() throws Exception {
        ...
        EnvExtractor envExtractor = new NugetEnvExtractor(build, buildInfo, resolver, listener, launcher, tempDir, env, nugetArgs, module, nugetBuild.useDotnetCli(), nugetBuild.useNugetV3());
