...
public class DockerPushExecutor extends BuildInfoProcessRunner {
    ...
    public DockerPushExecutor(ArtifactoryServer pipelineServer, BuildInfo buildInfo, Run build, String imageTag, String targetRepo, String host, String javaArgs, Launcher launcher, HashMap<String, String> properties, TaskListener listener, FilePath ws, EnvVars envVars) {
    ...
    public void execute() throws Exception {
        ...
        EnvExtractor envExtractor = new DockerEnvExtractor(build, buildInfo, deployer, listener, launcher, tempDir, env, imageTag, host, properties);
